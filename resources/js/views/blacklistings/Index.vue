                ...
                <div class="intro-y box">
                    <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                        ...
                        <div class="form-check w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                            <button class="btn btn-success shadow-md mr-2" @click.prevent="$router.push({name: 'admin.blacklistings.create'})">
...
export default {
    ...
    data(){
        ...
        let columns = [
            { label: 'Uploading Order', name: 'blacklist_order', orderable: true },
            { label: 'Cases Disposed Off', name: 'blacklisting_case_disposed_off', orderable: true},
            { label: 'Pending Cases', name: null, colspan:2},
