                    ...
                    <div class="p-5">
                        <div class="preview">
                            ...
                            <form class="validate-form w-1/2">
                                ...
                                <div class="input-form mt-5" :class="{'has-error':(errors && errors.complaint_status)}">
                                    <label class="form-label w-full flex flex-col sm:flex-row">
                                    ...
                                    <div class="flex flex-col sm:flex-row mt-2">
                                        <div class="form-check mr-2">
                                            <input v-model="form.complaint_status" id="active_status" class="form-check-input" type="radio" name="complaint_status" value="1">
                                            <label class="form-check-label" for="active_status">Active</label>
                                        </div>
                                        <div class="form-check mr-2 mt-2 sm:mt-0">
                                            <input v-model="form.complaint_status" id="inactive_status" class="form-check-input" type="radio" name="complaint_status" value="0">
                                            <label class="form-check-label" for="inactive_status">Inactive</label>
                                        </div>
                                    </div>

                                    <div class="pristine-error text-primary-3 mt-2" v-if="errors && errors.complaint_status">
                                        {{  errors.complaint_status[0] }}</div>
                                </div>
