                    ...
                    <div class="p-5">
                        <div class="preview">
                            ...
                            <div class="grid grid-cols-12 gap-6">
                                ...
                                <p class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center" v-if="getCollection.meta && !getCollection.meta.total">Currently no tender fee is added.</p>
...
export default {
    ...
    methods: {
        loadCollection: function(url = '/api/v1/tender-fees'){
        ...
        deleteRecord: function (delete_id = this.delete_id){
            this.processing = true;
            axios.post(`/api/v1/tender-fees/${delete_id}`, { _method : 'DELETE' }).then((resp) => {
