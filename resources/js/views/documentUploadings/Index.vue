                ...
                <div class="intro-y box">
                    <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                        ...
                        <div class="form-check w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                            <button class="btn btn-success shadow-md mr-2" @click.prevent="$router.push({name: 'admin.documents-uploadings.create'})">
...
export default {
    ...
    data(){
        ...
        let columns = [
            { label: 'Documents Uploaded', name: 'uploading_documents', orderable: true },
    ...
    methods: {
        ...
        deleteRecord: function (delete_id = this.delete_id){
            this.processing = true;
            axios.post(`/api/v1/documents-uploadings/${delete_id}`, { _method : 'DELETE' }).then((resp) => {
