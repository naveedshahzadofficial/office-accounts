                ...
                <div class="intro-y box">
                    <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                        ...
                        <div class="form-check w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                            <button class="btn btn-primary shadow-md mr-2" @click.prevent="$router.push({name: 'admin.procuring-agencies.create'})">
                                ...
                                <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                                    <BaseTableComponent :columns="columns" :sortKey="sortKey" :sortOrders="sortOrders" @sortBy="sortBy">
                                        ...
                                        <tr class="hover:bg-gray-200" v-for="row in getCollection.data" :key="row.id">
                                            ...
                                            <td class="border-b dark:border-dark-5 text-center"><span :class="row.agency_status?'text-theme-9':'text-theme-6'">{{ row.agency_status?'Active':'Inactive' }}</span></td>
...
export default {
    ...
    data(){
        ...
        let columns = [
            { label: 'Total No. of Procuring agencies Registered', name: 'agency_procuring_registered', orderable: true },
            { label: 'Date', name: 'created_at', orderable: true},
            { label: 'Status', name: 'agency_status', orderable: true},
    ...
    methods: {
        loadCollection: function(url = '/api/v1/procuring-agencies'){
        ...
        deleteRecord: function (delete_id = this.delete_id){
            this.processing = true;
            axios.delete(`/api/v1/procuring-agencies/${delete_id}`).then((resp) => {
