                    ...
                    <div class="p-5">
                        <div class="preview">
                            ...
                            <div class="grid grid-cols-12 gap-6">
                                ...
                                <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                                    <BaseTableComponent :columns="columns"  :sortKey="sortKey" :sortOrders="sortOrders" @sortBy="sortBy">
                                        ...
                                        <tr class="hover:bg-gray-200" v-for="row in getCollection.data" :key="row.id">
                                            <td class="border-b dark:border-dark-5 text-center">{{ row.value }}</td>
                                            ...
                                            <td class="border-b dark:border-dark-5 text-center">
                                                <router-link class="mr-2" title="Edit"  :to="{ name: 'admin.attributes.attribute-values.edit', params: { attribute_id: $route.params.attribute_id, id: row.id } }">
                                ...
                                <p class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center" v-if="getCollection.meta && !getCollection.meta.total">Currently no attribute value is added.</p>
...
export default {
    ...
    data(){
        ...
        let columns = [
            { label: 'Value', name: 'value', orderable: true },
    ...
    computed:{
        ...
        getAdditional: function (){
            return this.collection?this.collection.attribute:{};
        },
        pagination: function(){
    ...
    methods: {
        loadCollection: function(url = `/api/v1/attributes/${this.$route.params.attribute_id}/attribute-values`){
        ...
        deleteRecord: function (delete_id = this.delete_id){
            this.processing = true;
            axios.post(`/api/v1/attributes/${this.$route.params.attribute_id}/attribute-values/${delete_id}`, { _method : 'DELETE' }).then((resp) => {
