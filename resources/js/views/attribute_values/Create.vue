            ...
            <div class="intro-y col-span-12 lg:col-span-12">
                ...
                <div class="intro-y box">
                    <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                        <h2 class="font-medium text-base mr-auto">Add Attribute Value</h2>
                    </div>
                    <div class="p-5">
                        <div class="preview">
...
export default {
    ...
    methods: {
        saveForm: function (){
            ...
            axios.post(`/api/v1/attributes/${this.$route.params.attribute_id}/attribute-values`, this.form).then((resp) => {
