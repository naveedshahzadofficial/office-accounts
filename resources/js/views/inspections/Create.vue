            ...
            <div class="intro-y col-span-12 lg:col-span-12">
                ...
                <div class="intro-y box">
                    <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                        <h2 class="font-medium text-base mr-auto">Add Inspection</h2>
                    </div>
                    <div class="p-5">
                        <div class="preview">
                            ...
                            <form class="validate-form w-1/2">
                                ...
                                <div class="input-form mt-5" :class="{'has-error':(errors && errors.inspection_status)}">
                                    <label class="form-label w-full flex flex-col sm:flex-row">
                                    ...
                                    <div class="flex flex-col sm:flex-row mt-2">
                                        <div class="form-check mr-2">
                                            <input v-model="form.inspection_status" id="active_status" class="form-check-input" type="radio" name="inspection_status" value="1">
                                            <label class="form-check-label" for="active_status">Active</label>
                                        </div>
                                        <div class="form-check mr-2 mt-2 sm:mt-0">
                                            <input v-model="form.inspection_status" id="inactive_status" class="form-check-input" type="radio" name="inspection_status" value="0">
                                            <label class="form-check-label" for="inactive_status">Inactive</label>
                                        </div>
                                    </div>

                                    <div class="pristine-error text-primary-3 mt-2" v-if="errors && errors.inspection_status">
                                        {{  errors.inspection_status[0] }}</div>
                                </div>
...
export default {
    ...
    data: () => ({
        form:{
            ...
            inspection_miscellaneous_disposed_off: '',
            inspection_status: '',
        },
        errors: [],
        processing: false,
    ...
    methods: {
        saveForm: function (){
            ...
            axios.post('/api/v1/inspections', this.form).then((resp) => {
